...
//        $this->SetDrawColor(102, 405, 145);
        $this->MultiCell(80, 5, utf8_decode($_SESSION["titre"]), 0, 'C', FALSE);
        // Saut de ligne
//        $this->Ln(8);
        // D�calage � droite
//        $this->Cell(70);
...
// Pied de page
    function Footer() {
        ...
        // Numéro de page
        $this->Cell(0, 10, 'Copyright SI-TECMAVS Ci' . date('Y') . ' -- Page ' . $this->PageNo() . '/{nb}', 0, 0, 'R');
    }
